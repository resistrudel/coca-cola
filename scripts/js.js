...
function doParallaxCalc(element, speed) {
    var elOffset = element.offset().top;
    var topDist = $(window).scrollTop();
    var viewportHeight = $(window).height();
    var elInViewportAt = elOffset - viewportHeight;
//    if(elInViewportAt-topDist < 0) {
//        console.log('translateY(' + ((elInViewportAt-topDist)/speed) + 'px)');
//        element.css('transform', 'translateY(' + ((elInViewportAt-topDist)/speed) + 'px)');
//    }
    $('.bg-image').css('transform', 'translateY(' + ((topDist / 20) * 10) + 'px)');
}
//function parallaxAll() {
//    doParallaxCalc($('.big-bubble'), 3);
//    doParallaxCalc($('.small-bubble'), 1.8);
//    doParallaxCalc($('.bubble1'), 2);
//    doParallaxCalc($('.bubble2'), 2);
//    doParallaxCalc($('.bubble3'), 2);
//    doParallaxCalc($('.bubble4'), 1.5);
//    doParallaxCalc($('.bubble5'), 1.5);
//    doParallaxCalc($('.bubble6'), 1.5);
//    doParallaxCalc($('.bubble7'), 1.5);
//};
    ...
    var viewport = $(window),
        setVisible = function (e) {
            ...
            $('.bubblewrap').each(function () {
                ...
                //bottomOnScreen = bottom = viewportBottom,
                //elemVisible = topOnScreen || bottomOnScreen;
                console.log(bottom);
                console.log(viewportBottom);
                if (bottom <= viewportBottom + halfHeight) {
                    self.addClass('animation');
                }
                //self.addClass('animation', elemVisible);
            });
        };
