...
$client = array(
    'key' => 'cocaCola',
    'slogan' => '',
    'link' => 'https://www.cocacola.co.uk/coca-cola/trucktour-2017/',
    'name' => 'Coca-Cola'
);
 ...
 */
$siteDetails = array(
    'brands' => array('capital'),
    'baseURL' => 'https://' . $_SERVER['HTTP_HOST'] . '/coca-cola/',
    'localPath' => $_SERVER['DOCUMENT_ROOT'] . '/coca-cola/',
    'database' => 'competitions2017',
    'table' => array(
        'capital' => 'capitalCocaCola2017',
    )
);